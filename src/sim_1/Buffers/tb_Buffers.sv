...
module tb_Buffers;
    ...
    ID_EX_Buffer #(.NB_PC(NB_PC), .DATA_WIDTH(DATA_WIDTH), .NB_REG(NB_REG)) u_id_ex (
        .i_clk          (clk),
        .i_reset        (id_ex_reset),
    ...
    EX_MEM_Buffer #(.DATA_WIDTH(DATA_WIDTH), .NB_REG(NB_REG)) u_ex_mem (
        .i_clk         (clk),
    ...
    MEM_WB_Buffer #(.DATA_WIDTH(DATA_WIDTH), .NB_REG(NB_REG)) u_mem_wb (
        .i_clk          (clk),
    ...
    initial begin
        // ---------- reset all ----------
        id_ex_reset  = 1; id_ex_enable  = 0;
        ex_mem_reset = 1; ex_mem_enable = 0;
        mem_wb_reset = 1; mem_wb_enable = 0;

        id_ex_i_PC = 0; id_ex_i_rd1 = 0; id_ex_i_rd2 = 0;
        id_ex_i_imm = 0; id_ex_i_rd = 0; id_ex_i_funct3 = 0;
        id_ex_i_funct7_5 = 0; id_ex_i_ALUSrc = 0; id_ex_i_ALUOp = 0;
        id_ex_i_RegWrite = 0; id_ex_i_MemRead = 0; id_ex_i_MemWrite = 0;
        id_ex_i_MemToReg = 0; id_ex_i_Branch = 0; id_ex_i_Jump = 0;

        ex_mem_i_alu = 0; ex_mem_i_zero = 0; ex_mem_i_rd2 = 0;
        ex_mem_i_rd = 0; ex_mem_i_RegWrite = 0; ex_mem_i_MemRead = 0;
        ex_mem_i_MemWrite = 0; ex_mem_i_MemToReg = 0;
        ex_mem_i_Branch = 0; ex_mem_i_Jump = 0;

        mem_wb_i_alu = 0; mem_wb_i_mem = 0; mem_wb_i_rd = 0;
        mem_wb_i_RegWrite = 0; mem_wb_i_MemToReg = 0;
