...
module tb_IF();
    ...
    initial begin
        ...
        /* Comentado para usar carga automática desde program.hex
        //escribimos datos  
        mem_wr = 1'b1;
        mem_addr = 8'd0;
        mem_data = 32'b1010;
        ...
        */
        ...
        mem_wr = 1'b0; // Asegurarse de que no estamos escribiendo
        enable = 1'b1;

        #100; // Dar más tiempo para ver las instrucciones cargadas
        $finish;
